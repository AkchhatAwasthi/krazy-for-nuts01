...
import { Nut, Filter, Search } from 'lucide-react'; // ✅ Fixed import
...
const ProductsPage: React.FC<ProductsPageProps> = ({ addToCart }) => {
    ...
    const loadData = async () => {
      ...
      try {
        const [productsData, categoriesData] = await Promise.all([
          ...
          getCategoriesByPage('Dry Fruit Delights')
        ]);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-yellow-50 to-yellow-100"> {/* ✅ Safe Tailwind colors */}
      {/* Hero Banner */}
      <div className="relative overflow-hidden bg-gradient-to-r from-yellow-800 to-yellow-900"> {/* ✅ Safe colors */}
        <div className="absolute inset-0">
          <img
            src="https://images.pexels.com/photos/1295572/pexels-photo-1295572.jpeg"
            alt="Dry Fruit Delights"
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
          <div className="text-center">
            <div className="flex items-center justify-center mb-6">
              <Nut className="w-16 h-16 text-yellow-400 mr-4" />
              <Nut className="w-20 h-20 text-yellow-400" />
              <Nut className="w-16 h-16 text-yellow-400 ml-4" />
            </div>
            <h1 className="text-5xl md:text-6xl font-times font-bold text-white mb-6">
              Dry Fruit Delights
            </h1>
            <p className="text-xl md:text-2xl font-inter text-yellow-100 max-w-3xl mx-auto leading-relaxed">
              Premium quality dry fruits and nuts sourced directly from nature's finest orchards. 
              Fresh, nutritious, and packed with natural goodness.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="text-center mb-12">
          <p className="text-yellow-600 font-inter font-semibold text-lg mb-4 tracking-wide">
            PREMIUM COLLECTION
          </p>
          <h2 className="text-4xl md:text-5xl font-inter font-bold text-yellow-900 mb-6">
            Our Dry Fruit Collection
          </h2>
          <p className="text-xl font-inter text-yellow-700 max-w-3xl mx-auto">
            From crunchy almonds to sweet dates, discover our extensive range of premium dry fruits 
            perfect for healthy snacking and gifting.
          </p>
        </div>
        ...
        <div className="mb-12">
          <div className="flex items-center justify-center mb-6">
            <Filter className="w-6 h-6 text-yellow-700 mr-2" />
            <h3 className="text-xl font-inter font-semibold text-yellow-900">
              Filter by Category
            </h3>
          </div>
            ...
            <button
              ...
              className={`px-6 py-3 rounded-full font-inter font-medium transition-all duration-200 ${
                selectedCategory === 'all'
                  ...
                  : 'bg-white text-yellow-800 hover:bg-amber-50 hover:text-amber-800 border border-yellow-200'
              }`}
            >
        ...
        <div className="max-w-md mx-auto mb-12">
          <div className="relative">
            ...
            <input
              ...
              placeholder="Search dry fruits and nuts..."
            />
          </div>
        </div>
        {loading ? (
          <div className="text-center py-16">
            <div className="inline-block animate-spin rounded-full h-16 w-16 border-4 border-yellow-200 border-t-yellow-600 mb-6"></div>
            <p className="text-xl font-inter text-yellow-700">Loading premium dry fruits...</p>
          </div>
        ) : (
          <>
            <div className="mb-8">
              <p className="text-xl font-inter text-yellow-700 text-center">
          ...
          <div className="text-center py-20">
            <div className="bg-white rounded-2xl shadow-lg p-12 max-w-md mx-auto">
              {searchTerm.trim() !== '' ? (
                ...
                <Nut className="w-16 h-16 text-gray-400 mx-auto mb-6" />
              )}
              ...
              <p className="text-lg font-inter text-gray-400">
                {searchTerm.trim() !== '' 
                  ...
                  : selectedCategory !== 'all' 
                    ...
                    : 'Please check back later for our premium dry fruit collection.'
                }
              </p>
            </div>
          </div>
